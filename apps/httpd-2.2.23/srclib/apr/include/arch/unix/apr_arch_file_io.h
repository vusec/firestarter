...
#ifndef WAITIO_USES_POLL
#define APR_FILE_INIT_WAITIO_USES_POLL ,NULL
#else
#define APR_FILE_INIT_WAITIO_USES_POLL
#endif

#if APR_HAS_THREADS
#define APR_FILE_INIT_APR_HAS_THREADS ,0
#else
#define APR_FILE_INIT_APR_HAS_THREADS
#endif

#define APR_FILE_INIT_NULL() { NULL, -1, NULL, 0, 0, 0, 0, 0, 0, 0 APR_FILE_INIT_WAITIO_USES_POLL , NULL, 0, 0, 0, 0, 0 APR_FILE_INIT_APR_HAS_THREADS }

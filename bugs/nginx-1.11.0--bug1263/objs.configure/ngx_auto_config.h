#define NGX_CONFIGURE " --prefix=/mnt/hdd/koustubha/repos/firestarter/bugs/nginx-1.11.0--bug1263/install --with-cc=/mnt/hdd/koustubha/repos/apprecovery/autosetup.dir/src/x86_64/llvm-4.0/bin/bin/clang --with-cc-opt='-Wno-error -O0 -DLLVM_HAS_MPX=1 -fasynchronous-unwind-tables -fPIC -g -I/mnt/hdd/koustubha/repos/firestarter/llvm/include -flto -O0 -fasynchronous-unwind-tables -g -pthread' --with-ld-opt=' -flto -O0 -O0 -g3 -Wl,-plugin-opt=-disable-fp-elim -Wl,-plugin-opt=save-temps -rdynamic -pthread -lpthread -lgcc_s -lrt -ldl' --with-http_ssl_module --with-http_realip_module --with-http_addition_module --with-http_sub_module --with-http_dav_module --with-http_flv_module --with-http_mp4_module --with-http_gunzip_module --with-http_gzip_static_module --with-http_random_index_module --with-http_secure_link_module --with-http_stub_status_module --with-http_auth_request_module --with-mail --with-mail_ssl_module --with-http_v2_module --with-threads --with-http_slice_module"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "clang 4.0.1 (git@github.com:llvm-mirror/clang.git 3c8961bedc65c9a15cbe67a2ef385a0938f7cfef) (git@github.com:llvm-mirror/llvm.git c8fccc53ed66d505898f8850bcc690c977a7c9a7)"
#endif
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/mnt/hdd/koustubha/repos/firestarter/bugs/nginx-1.11.0--bug1263/install/"
#endif
